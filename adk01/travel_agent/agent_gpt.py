...
# 1. Import LiteLLM to enable support for non-Google models
from google.adk.models.lite_llm import LiteLlm
from dotenv import load_dotenv, find_dotenv

# Load environment variables from .env (OPENAI_API_KEY must be present)
load_dotenv(find_dotenv())

# 2. Configure the OpenAI model via the LiteLLM adapter. 
# Use 'openai/gpt-4o' for the current flagship model.
