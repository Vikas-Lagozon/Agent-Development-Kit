...
7. hello_world_agent
   - Roll dice of any number of sides.
...
7. Dice & Primes:
   Delegate to hello_world_agent when the user wants to:
   - Roll a die (any number of sides)
   - Check if one or more numbers are prime
   - Combine both: roll a die and check if the result is prime
